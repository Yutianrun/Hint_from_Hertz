...
def main():
    ...
    if plot_freq:
        ...
        for label, trace in freq_label_dict.items():
            ...
            sk_index = int(label_list[3])
            curr = int(label_list[0]) in hit_z[sk_index]
        ...
        fig = go.Figure()
        Hamming_category = ['$(C_0,C_1,0,...)$', '$(C_2,0,0,...) \\ /(0,C_3,0,...)$']
        ...
        fig.update_layout(
                    yaxis_title=r'',
                    xaxis_title='Frequency Means (GHz)'
                    )
        ...
        fig.update_layout(height = 280, width = 600,font_size=10,font_color='black',font_family='Times New Roman', legend_font_size = 10,title_font_size = 10,margin=dict(l=0,r=30,b=0,t=0),)
