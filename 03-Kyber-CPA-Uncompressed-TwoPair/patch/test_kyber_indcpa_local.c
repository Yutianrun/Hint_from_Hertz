...
void * kyber_thread(void *args)
{
    ...
    indcpa_dec_uncompressed(actual_args->m, actual_args->c, actual_args->sk);
    return 0;
}
...
int main(int argc, char *argv[]) {
    ...
    /* Fixed pair0 is always (1, guess_z1); search/guess target pair (1, guess_z2). */
    craft_ciphertext_two_pair(ct, guess_z1, guess_z2, target_pair_index);
