...
**************************************************/
void unpack_ciphertext(polyvec *b, poly *v, const uint8_t c[KYBER_UNCOMPRESSED_BYTES])
{
...
{
  unsigned int i;
  uint8_t buf[2*KYBER_SYMBYTES] ={8};
                ...
                const uint8_t sk[KYBER_INDCPA_SECRETKEYBYTES])
{
  ...
  // printf("\n");
  // if(mp.coeffs[0]==0||mp.coeffs[1]==0)
  //     printf("hit_here!!");
  poly_tomsg(m, &mp);
}
